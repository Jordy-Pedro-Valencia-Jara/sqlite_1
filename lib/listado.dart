  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacementNamed(context,"/editar",arguments: Animal(id:0,nombre:"",especie:""));
    ...
    return ListView.builder(
        ...
        itemBuilder:
          ...
          Dismissible(key: Key(i.toString()),
            ...
            child: ListTile(
              title: Text(animales[i].nombre??"vacio"),
              trailing: MaterialButton(
                onPressed: () {
                  Navigator.pushReplacementNamed(context,"/editar",arguments: animales[i]);
                },
